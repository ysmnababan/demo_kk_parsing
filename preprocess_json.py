...
if __name__ == '__main__':
    family = FamilyData.from_json_file('./output/kk_data.json')
    family.preprocess("./output/processed_data.json")
    family.print_all()

    # You can now access fields directly
    print("\nFirst name:", family.names[0])
    print("Kecamatan:", family.kecamatan)